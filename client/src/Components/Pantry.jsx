...
class Pantry extends Component {
  ...
  render() {
    ...
    if (this.state.queue.length > 0) {
        ...
        return (
          <div key={i} className="queue-box">
            <ol>
              ...
              <button
                onClick={() => {
                  this.removeItemFromQueue(name);
                }}
                className="remove-frm-queue"
              >
                Remove
              </button>
            </ol>
      ...
      queueItems = <p>Add up to three ingredients.</p>;
    }
    let pantryItems;
    ...
    if (this.state.data.length > 0) {
      ...
      pantryItems = <p>Your Pantry is empty! </p>;
    }
    ...
    return (
      <>
        ...
        <p className="logout">
          Not you?{" "}
          <a className="logout" href="/login" onClick={this.props.logout}>
            Log out!
          </a>
        </p>
        ...
        <div className="recipe-box">
          <h3 className="queue-header">
            Recipe Queue: {this.state.queue.length}
          </h3>
          {queueItems}
          <div className="queue-btn-box">
            <button
              className="queue-btn-box-btn"
              onClick={() => {
                this.resetQueue();
              }}
            >
            ...
            <Link
              ...
              to="/recipes"
              onClick={() => {
                this.props.submitRecipe(this.state.queue);
              }}
            >
              Find Recipes
            </Link>
